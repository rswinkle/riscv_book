...
https://github.com/TheThirdOne/rars/wiki/Environment-Calls[system calls] (aka syscalls,
environment calls, ecalls) from the RARS wiki.
...
RARS 4.5  Copyright 2003-2019 Pete Sanderson and Kenneth Vollmar
