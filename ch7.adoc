...
Following the table, you can see the `move` became `or`, the ``li``'s became
...
https://raw.githubusercontent.com/rswinkle/mips_book/master/code/args_bare.s[args_bare.s]
which is just
https://raw.githubusercontent.com/rswinkle/mips_book/master/code/args.s[args.s]
in bare mode for a complete example.
